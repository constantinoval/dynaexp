...
class Ui_dynaexp_main_window(object):
    def setupUi(self, dynaexp_main_window):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/add.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.small_menu_frame.setMinimumSize(QSize(31, 0))
        self.small_menu_frame.setMaximumSize(QSize(31, 100000))
        ...
        self.connect_btn_small.setMinimumSize(QSize(30, 30))
        self.connect_btn_small.setMaximumSize(QSize(30, 30))
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/database (1).png", QSize(), QIcon.Normal, QIcon.Off)
        self.connect_btn_small.setIcon(icon4)
        self.connect_btn_small.setIconSize(QSize(20, 20))
        ...
        self.tables_btn_small.setMinimumSize(QSize(30, 30))
        self.tables_btn_small.setMaximumSize(QSize(30, 30))
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/trigger.png", QSize(), QIcon.Normal, QIcon.Off)
        self.tables_btn_small.setIcon(icon5)
        self.tables_btn_small.setIconSize(QSize(20, 20))
        ...
        self.exit_btn_small.setMinimumSize(QSize(30, 30))
        self.exit_btn_small.setMaximumSize(QSize(30, 30))
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/remove-button.png", QSize(), QIcon.Normal, QIcon.Off)
        self.exit_btn_small.setIcon(icon6)
        self.exit_btn_small.setIconSize(QSize(20, 20))
